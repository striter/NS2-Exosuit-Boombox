...
if kTranslateMessage then
    ...
    kTranslateMessage["BOOMBOX_OST"]="游戏"
    kTranslateMessage["BOOMBOX_SONG"]="外语1"
    kTranslateMessage["BOOMBOX_ANIME"]="外语2"
    kTranslateMessage["BOOMBOX_CUSTOM"]="定制"
    kTranslateMessage["BOOMBOX_VOLUME"]="音量"
...
if kLocales then
    ...
    kLocales["BOOMBOX_ANIME"]="Anim"
    kLocales["BOOMBOX_CUSTOM"]="Cstm"
    kLocales["BOOMBOX_VOLUME"]="Vol"
