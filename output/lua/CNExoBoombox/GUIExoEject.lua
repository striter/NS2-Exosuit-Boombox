...
function GUIExoEject:Initialize()
    ...
    self.text1:SetText(Locale.ResolveString("BOOMBOX_CUSTOM"))
    ...
    self.text2:SetText(Locale.ResolveString("BOOMBOX_OST"))
    ...
    self.text3:SetText(Locale.ResolveString("BOOMBOX_ANIME"))
    ...
    self.text4:SetText(Locale.ResolveString("BOOMBOX_SONG"))
